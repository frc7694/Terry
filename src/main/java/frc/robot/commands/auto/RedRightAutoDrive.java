...
public class RedRightAutoDrive extends SequentialCommandGroup {
    public RedRightAutoDrive() {
        ...
        addCommands(new DriveCommand(.3, .3, RobotContainer.m_robotSemiAuto.getR(), () -> RobotContainer.m_odometry.getY() <= -2.5));
